...
public class GoogleApi {
	...
	private String googleClientId; 		// Google Client Id
	
	@Value("${spring.security.oauth2.client.registration.google.client-secret}")
	private String googleClientPw;	// Google Client Pw
	
	@Value("${google.redirect_uri}")
	private String redirect_uri; 	// 사용자 인증 후 리디렉션될 URI
	...
	public String getAccessToken(String code) {
		...
		try {
			...
			sb.append("&client_id=").append(googleClientId);	// Google API Key
			sb.append("&client_secret=").append(googleClientPw);// Google secret
			sb.append("&redirect_uri=").append(reqUrl);			// 리디렉션 URI
